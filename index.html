		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li ><a href="Yoho/login.php">Login</a></li>
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
							<form class="form-wrap" action="#">
								...
								<div class="form-select" id="service-select">
									<select>
										<option data-display="">Departement Type</option>
								...
								<div class="form-select" id="service-select1">
									<select>
										<option data-display="">Doctor </option>
										<option value="1">Type One</option>
										<option value="2">Type Two</option>
										<option value="3">Type Three</option>
										<option value="4">Type Four</option>
		    ...
		    <section class="team-area section-gap">
		            ...
		            <div class="row justify-content-center d-flex align-items-center">
		                <div class="col-lg-3 col-md-6 single-team">
		                    <div class="thumb">
								...
								<hr>
								<h4>Andy Florence</h4>
									<p>HOD of Neurology Department<br>abc1234@gmail.com</p>
				...
				<center>
					<div class="controls-top">
						<a style="background-color: #69be00" class="btn text-light  " href="#multi-item-example" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
						<a  style="background-color: #69be00" class="btn text-light " href="#multi-item-example" data-slide="next"><i
